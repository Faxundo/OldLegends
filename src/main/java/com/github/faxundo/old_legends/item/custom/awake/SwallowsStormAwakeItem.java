...
public class SwallowsStormAwakeItem extends SwallowsStormItem {
    ...
    private int explosionDamage = CONFIG.swallowsStorm.swallowsStormAwakeExplosiveDamage;
    private int explosionRange = CONFIG.swallowsStorm.swallowsStormAwakeExplosiveRange;
    private int explosionKnockback = CONFIG.swallowsStorm.swallowsStormAwakeExplosiveKnockback;
